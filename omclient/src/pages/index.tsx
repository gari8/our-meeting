...
const Home: FC = () =>  {
    return (
        <>
            ...
            />
            <Layout>
                <h1 className="description text-center text-5xl my-5">ブレストってなに？</h1>
                <div className="flex justify-center my-20">
                    <div className="w-1/3 m-10">
                        <img src="/static/brst.svg" />
                    </div>
                    <p className="break-words text-white text-center text-md m-10 w-1/3 leading-relaxed">
                ...
                <h2 className="navigator text-center text-2xl"><Link href="/">＞早速使ってみる</Link></h2>
            </Layout>
            <style jsx>{`
                .description {
